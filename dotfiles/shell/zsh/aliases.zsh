...
# Shared aliases — sourced by both zsh (here) and bash (via aliases.sh symlink)
...
alias rabble-dots='cd ~/git/RaBbLE && ansible-playbook -i ansible/inventory/hosts.yml ansible/playbooks/deploy-dotfiles.yml -K'
