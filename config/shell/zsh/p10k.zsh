...
# Hand-tuned for RaBbLE synthwave palette. Run `p10k configure` to regenerate,
# then copy back here. Colors use ANSI 256 approximations of the hex palette:
#   198 ≈ #ff2d78 magenta   135 ≈ #bf5fff violet   51 ≈ #00f5ff cyan
#   84  ≈ #50fa7b green     160 ≈ #e05c6f red
